...
URL = "https://api.github.com/search/repositories?q=language:java+created:2016-03-01..2016-03-31+stars:>20&per_page=100&sort=stars&order=desc"
URL_List.append(URL)
...
def clone(URL, id, stars):
    ...
    command += " E://javaProjectsFromGithub//2016//Mar//" + project_name + "_" + str(id) + "_" + str(stars)
    os.system(command)
...
for i in URL_List:
    crawl(i)
    pyexcel.save_as(records=result, dest_file_name="D:\\2016_Mar.xlsx")
